...
def odwazniki_rekurencyjnie_obie_szalki(t, n, p=0):
	...
	if p == len(t):
		return False
	return odwazniki_rekurencyjnie_obie_szalki(t, n - t[p], p + 1) or odwazniki_rekurencyjnie_obie_szalki(t, n,
																																																				p + 1) or odwazniki_rekurencyjnie_obie_szalki(
		t, n + t[p], p + 1)


def waga(t, n, p=0,
				 r=[]):  # funkcja zwracająca jakie odważniki mają leżeć na której szalce, r - result to tablica, która przetrzymuje jakie odważniki wzięliśmy
	# print('*', end='')
